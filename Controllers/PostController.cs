...
using BlogAspNet_Env.ViewModels.Posts;
...
public class PostController : ControllerBase
{
        ...
        [FromRoute] int id)
    {
        ...
        {
            return StatusCode(500,
                new ResultViewModel<Post>("05X04 - Falha interna no servidor"));
        }
    }
       ...
       [FromQuery] int pageSize = 25)
    {
        ...
        {
            return StatusCode(500,
                new ResultViewModel<List<Post>>("05X04 - Falha interna no servidor"));
        }
    }
}
